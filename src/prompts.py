...
#     Precautions: Maintain good living habits, avoid excessive tension and anxiety, and have regular follow-ups.
# - Query:
# The patient is a 42-year-old female who was found to have an intracranial mass during a physical examination conducted over two months ago. The patient had no dizziness, headaches, nausea, vomiting, muscle weakness, sensory abnormalities, language dysfunction, or seizures. T1-weighted MRI with contrast revealed a nodular enhancement beneath the left cingulate gyrus. CT showed a slightly lower density lesion on the deep surface of the left frontal lobe near the knee of the corpus callosum with unclear borders. PET scan indicated increased radioactive uptake with a maximum SUV of 2.7.
# Physical Examination: KPS 90, GCS 15, MS V-grade, Babinski sign negative.'''
# print(rag.query(prompt, param=QueryParam(mode="mix", top_k=5)))
